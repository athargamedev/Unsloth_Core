#!/usr/bin/env python3
"""
sanitize_dataset.py — Dataset Quality & Format Sanitizer

This script validates ChatML structure, removes common AI artifacts,
and ensures conversational constraints (length, role sequence) are met.

Usage:
    ./ucore sanitize subjects/datasets/my_npc/template/train.jsonl
    python scripts/sanitize_dataset.py subjects/datasets/my_npc/ollama/train.jsonl --strict-canonical

Technical Details:
- Input: Raw JSONL dataset (generated by Stage 1).
- Output: train_clean.jsonl (Stage 2 output).
- Filters: Strips "As an AI language model..." and ensures 1-5 sentence responses.
"""
...
def main():
    ...
    parser.add_argument("--strict-canonical", action="store_true",
                        help="Fail unless input path is canonical subjects/datasets/{npc_key}/{technique}/train.jsonl")

...
Usage:
  python scripts/orchestration/plan_execution.py --spec subjects/NPC_specs/chemistry_instructor.json --preset fast-3b --json
  python scripts/orchestration/plan_execution.py --spec subjects/NPC_specs/chemistry_instructor.json --preset llama-3b-fast --local-vram-gb 6
"""

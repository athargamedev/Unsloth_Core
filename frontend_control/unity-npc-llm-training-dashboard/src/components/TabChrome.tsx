...
export const TabChrome = ({ icon: Icon, title, description, tip, chips = [], status, className }: TabChromeProps) => (
  <motion.div
    ...
    className={cn('mx-4 mt-4 rounded-xl border border-line/70 bg-surface/70 backdrop-blur-md overflow-hidden', className)}
  >
    <div className="flex flex-col gap-4 p-4 xl:flex-row xl:items-center xl:justify-between">
      <div className="flex min-w-0 items-start gap-3">
        ...
        <div className="min-w-0">
          ...
          <p className="mt-1 max-w-3xl text-[11px] leading-relaxed text-ink/55">{description}</p>
      ...
      <div className="flex max-w-xl items-start gap-2 rounded-lg border border-warning/20 bg-warning/5 px-3 py-2 text-[10px] text-warning/90 xl:items-center">

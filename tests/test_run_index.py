...
def test_refresh_run_index(tmp_path, monkeypatch):
    ...
    bundle.write_text('{"run_id": "run_1", "stage": "generate", "npc_key": "history_guide", "technique": "ollama", "created_at": "now", "metrics": {"pass_rate": 1.0}, "artifacts": {"train": "x"}}\n', encoding="utf-8")
...
def test_build_index_entry_uses_bundle_fields(tmp_path):
    ...
    bundle = {"run_id": "run_2", "stage": "dataset_eval", "npc_key": "chef_assistant", "technique": "ollama", "created_at": "now", "metrics": {"pass_rate": 0.5}}

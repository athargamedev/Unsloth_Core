...
4. The docs-backed generation workflow is documented in [TRAINING_WORKFLOW_CONTEXT.md](TRAINING_WORKFLOW_CONTEXT.md) and [reference/CLI_REFERENCE.md](reference/CLI_REFERENCE.md).

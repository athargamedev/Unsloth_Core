      ...
      <div className="space-y-3">
        ...
        <div className="flex gap-2">
          ...
          <button
            ...
            title={!status?.deployScript ? 'No Unity deploy entrypoint found. Use scripts/export/deploy_to_unity.py or ./ucore deploy.' : 'Deploy all exported models'}
          >
        ...
        {/* Setup guidance when deploy script missing */}
        {status && !status.deployScript && (
          <div className="p-3 bg-warning/10 border border-warning/30 rounded text-[10px] text-warning/90 leading-relaxed">
            ...
            <p>Use <code className="bg-black/30 px-1 rounded font-mono">scripts/export/deploy_to_unity.py</code> or <code className="bg-black/30 px-1 rounded font-mono">./ucore deploy</code> to copy GGUF files into Unity.</p>

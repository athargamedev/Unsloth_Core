...
Usage:
    ./ucore train data/npcs/specs/chemistry_instructor.json --preset fast-3b
    python scripts/training/train.py data/npcs/specs/chemistry_instructor.json --from-spec --export-gguf

...
Usage:
  python scripts/orchestration/plan_execution.py --spec data/npcs/specs/chemistry_instructor.json --preset fast-3b --json
  python scripts/orchestration/plan_execution.py --spec data/npcs/specs/chemistry_instructor.json --preset llama-3b-fast --local-vram-gb 6
"""

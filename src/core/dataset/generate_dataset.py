#!/usr/bin/env python3
"""generate_dataset.py — Ollama-Optimized NPC Dataset Generator (PRODUCTION ENTRY POINT)

⚠  This is the PRODUCTION entry point for dataset generation.
   Use ``./ucore generate-ollama <spec>`` to invoke it.
...
- Input: Subject spec JSON file in data/npcs/specs/
- Output: data/datasets/{npc_key}/ollama/train.jsonl
"""
